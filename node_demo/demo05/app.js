...
/*
    ...
    .encoding   (String)            可选值，默认‘utf-8’,当data是buffer时，该值应该为
...
*/
/*
fs.writeFile('./html/index.html','hello nodejs哈哈哈',(err)=>{
    if(err){
        console.log(err);
        return;
    }
...
fs.readFile('./html/index.html',(err,data)=>{
    ...
    console.log(data.toString());//把buffer 转换成string类型
})

*/
/*
no such file or directory, open 'C:\Users\Administrator\Desktop\nodejs\node_demo\demo05\aaa\index.html
